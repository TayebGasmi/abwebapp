...
export class SessionListComponent implements OnInit, OnDestroy {
  ...
  constructor(private authService: AuthService, private sessionService: SessionService, private notificationService: NotificationService, private fb: FormBuilder, private rxStompService: RxStompService
  ) {
